...
public class MainMenuController : MonoBehaviour {
	...
	void Start ()
    {
        ...
        //splashScreenAnim.Play("SlideOut");
    ...
    public void MoreGameButton()
    {
        ...
        Application.OpenURL("https://play.google.com/store/apps/developer?id=Golden+Beetle");
        clickSound.Play();
    }
    ...
    {//this is to provide the info on how to play game
        Application.OpenURL("https://goldenbeetle.org/privacy-policy.html");
        clickSound.Play();
    }
    ...
    public void RateButton()
    {
        ...
        Application.OpenURL("https://play.google.com/store/apps/details?id=com.strawberryapps.learnenglishspellingsadv");
        clickSound.Play();
    }
