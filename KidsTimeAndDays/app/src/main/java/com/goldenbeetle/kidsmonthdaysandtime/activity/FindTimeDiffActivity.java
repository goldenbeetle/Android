...
public class FindTimeDiffActivity extends TaskActivity
    implements android.view.View.OnClickListener
{
    ...
    private FancyClock mFancyClockOne;
    private FancyClock mFancyClockTwo;
    private SharedPreferences mPreferences;
    private int selecttimesetting;

    public FindTimeDiffActivity()
    {
    }
    ...
    private void showAnswers()
    {
    	...
    	mFancyClockOne.setTime(mHoursOne, mMinutesOne);
    	...
    	mFancyClockTwo.setTime(gc.get(Calendar.HOUR), gc.get(Calendar.MINUTE)); 
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        setContentView(R.layout.findthediff);
        setBackgroundByResolution("bg_common");
        mTaskView = (TextView)findViewById(R.id.task);
        mFancyClockOne = (FancyClock) findViewById(R.id.fancyclockone);
        int dialType = Integer.parseInt(mPreferences.getString("clk_clockdial", "0"));
        switch(dialType) {
        	case 1:
        		mFancyClockOne.setDial(R.drawable.clock_dialroman);
        		break;
        	case 2:
        		mFancyClockOne.setDial(R.drawable.clock_dialnonum);
        		break;
        }
        
        mFancyClockTwo = (FancyClock) findViewById(R.id.fancyclocktwo);
        switch(dialType) {
    	case 1:
    		mFancyClockTwo.setDial(R.drawable.clock_dialroman);
    		break;
    	case 2:
    		mFancyClockTwo.setDial(R.drawable.clock_dialnonum);
    		break;
    }
    ...
    {
        super.onResume();
        selecttimesetting = Integer.parseInt(mPreferences.getString("clk_min_timediff", "30"));
        nextTask();
    }
